...
| 交互 | 预览 |
|---|---|
| 滚动钉住叙事 | ![Pinned scroll storytelling](./assets/previews/interactions/pinned-scroll-storytelling.gif) |
| Dashboard 滚动变形 | ![Scroll-scrub dashboard morph](./assets/previews/interactions/scroll-scrub-dashboard-morph.gif) |
| 横向案例墙 | ![Horizontal case wall](./assets/previews/interactions/horizontal-case-wall.gif) |
| Shared layout 过渡 | ![Shared layout transition](./assets/previews/interactions/shared-layout-transition.gif) |
| Three.js 产品轨道 Hero | ![Three.js product orbit hero](./assets/previews/interactions/threejs-product-orbit-hero.gif) |
| Shader / 液体揭示 | ![Shader liquid reveal](./assets/previews/interactions/shader-liquid-reveal.gif) |
| 磁吸媒体 Hover | ![Magnetic media hover](./assets/previews/interactions/magnetic-media-hover.gif) |
| 交互式 Orbit Network | ![Interactive orbit network](./assets/previews/interactions/interactive-orbit-network.gif) |
